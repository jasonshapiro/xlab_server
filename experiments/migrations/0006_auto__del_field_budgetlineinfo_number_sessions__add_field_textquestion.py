...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BudgetLineInfo.number_sessions'
        db.delete_column('experiments_budgetlineinfo', 'number_sessions')

        # Adding field 'TextQuestion.number_sessions'
        db.add_column('experiments_textquestion', 'number_sessions', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'BudgetLine.number_sessions'
        db.add_column('experiments_budgetline', 'number_sessions', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'BudgetLineInfo.number_sessions'
        raise RuntimeError("Cannot reverse this migration. 'BudgetLineInfo.number_sessions' and its values cannot be restored.")

        # Deleting field 'TextQuestion.number_sessions'
        db.delete_column('experiments_textquestion', 'number_sessions')

        # Deleting field 'BudgetLine.number_sessions'
        db.delete_column('experiments_budgetline', 'number_sessions')
