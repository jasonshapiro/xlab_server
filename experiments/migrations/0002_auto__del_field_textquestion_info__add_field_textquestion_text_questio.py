...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TextQuestion.info'
        db.delete_column('experiments_textquestion', 'info_id')

        # Adding field 'TextQuestion.text_question_info'
        db.add_column('experiments_textquestion', 'text_question_info', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['experiments.TextQuestionInfo']), keep_default=False)

        # Deleting field 'BudgetLine.info'
        db.delete_column('experiments_budgetline', 'info_id')

        # Adding field 'BudgetLine.budget_line_info'
        db.add_column('experiments_budgetline', 'budget_line_info', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['experiments.BudgetLineInfo']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'TextQuestion.info'
        raise RuntimeError("Cannot reverse this migration. 'TextQuestion.info' and its values cannot be restored.")

        # Deleting field 'TextQuestion.text_question_info'
        db.delete_column('experiments_textquestion', 'text_question_info_id')

        # User chose to not deal with backwards NULL issues for 'BudgetLine.info'
        raise RuntimeError("Cannot reverse this migration. 'BudgetLine.info' and its values cannot be restored.")

        # Deleting field 'BudgetLine.budget_line_info'
        db.delete_column('experiments_budgetline', 'budget_line_info_id')
