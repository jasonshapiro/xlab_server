...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Timer.experimentType'
        db.delete_column('experiments_timer', 'experimentType')

        # Adding field 'Timer.timer_type'
        db.add_column('experiments_timer', 'timer_type', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Timer.experimentType'
        raise RuntimeError("Cannot reverse this migration. 'Timer.experimentType' and its values cannot be restored.")

        # Deleting field 'Timer.timer_type'
        db.delete_column('experiments_timer', 'timer_type')
    ...
    models = {
        ...
        'experiments.timer': {
            ...
            'timer_type': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            'title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'})
        }
    }
