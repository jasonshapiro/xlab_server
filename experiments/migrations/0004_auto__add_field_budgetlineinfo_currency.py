...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BudgetLineInfo.currency'
        db.add_column('experiments_budgetlineinfo', 'currency', self.gf('django.db.models.fields.CharField')(default='-', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BudgetLineInfo.currency'
        db.delete_column('experiments_budgetlineinfo', 'currency')
