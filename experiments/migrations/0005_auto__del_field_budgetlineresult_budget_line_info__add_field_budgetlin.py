...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BudgetLineResult.budget_line_info'
        db.delete_column('experiments_budgetlineresult', 'budget_line_info_id')

        # Adding field 'BudgetLineResult.budget_line'
        db.add_column('experiments_budgetlineresult', 'budget_line', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['experiments.BudgetLine']), keep_default=False)

        # Deleting field 'TextQuestionResult.text_question_info'
        db.delete_column('experiments_textquestionresult', 'text_question_info_id')

        # Adding field 'TextQuestionResult.text_question'
        db.add_column('experiments_textquestionresult', 'text_question', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['experiments.TextQuestion']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'BudgetLineResult.budget_line_info'
        db.add_column('experiments_budgetlineresult', 'budget_line_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['experiments.BudgetLine'], null=True), keep_default=False)

        # Deleting field 'BudgetLineResult.budget_line'
        db.delete_column('experiments_budgetlineresult', 'budget_line_id')

        # User chose to not deal with backwards NULL issues for 'TextQuestionResult.text_question_info'
        raise RuntimeError("Cannot reverse this migration. 'TextQuestionResult.text_question_info' and its values cannot be restored.")

        # Deleting field 'TextQuestionResult.text_question'
        db.delete_column('experiments_textquestionresult', 'text_question_id')
